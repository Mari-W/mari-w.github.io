    ...
    <v-card flat tile width="100%" color="transparent">
      <v-card-text class="text-center">
        ...
        >
          ...
          <v-card flat color="#78909" class="ml-4">
            <v-btn class="ml-4 mt-4" icon dark @click="dialog = false">
            ...
            <v-card-text>
              E-Mail:
              <a
                href="mailto:legal@mariusweidner.de"
                style="color:white; text-decoration: none;"
                >legal@mariusweidner.de</a
              ><br />
              Internet address:
              <a
                href="https://mariusweidner.de"
                style="color:white; text-decoration: none;"
                >mariusweidner.de</a
              ><br />
